...
cd samples
cd aspnetapp
docker build --isolation process --pull -t aspnetapp .
docker run --isolation process --name aspnet_sample --rm -it -p 8000:80 aspnetapp
```

```
docker login quay.io
docker tag aspnetapp quay.io/cvicens/aspnetapp:0.0.1
docker push quay.io/cvicens/aspnetapp:0.0.1
```
